...
local function refuel()
    ...
    if fuelLevel >= fuelLimit then return true end
    ...
    for i = 1, 16 do
        ...
        local itemsToUse = math.min(
            math.ceil(fuelNeeded / fuelPerItem),
            turtle.getItemCount(i)
        )

        if itemsToUse <= 0 then goto continue end
...
-- TODO: Check if this also works with lava
local function mine()
